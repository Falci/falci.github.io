...
export default () => (
  <section className="bg-white rounded-xl shadow-lg overflow-hidden w-full md:w-3/5 lg:w-full">
    ...
    <div className="p-4 bg-white flex flex-wrap justify-between">
      ...
      <a
        href="?download"
        className="hidden bg-purple-700 hover:bg-purple-600 transition duration-300 rounded-lg text-white font-bold justify-center divide-x divide-purple-500 items-center"
      >
